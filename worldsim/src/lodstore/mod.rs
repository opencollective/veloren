...
pub trait LodConfig {
    ...
    fn setup(&mut self);
    fn drill_down(data: &mut LodData::<Self::own>, level: u8, index: usize);
    fn drill_up(data: &mut LodData::<Self::own>, level: u8, parent_index: usize);
}
...
impl<X: LodConfig> LodData<X> {
    ...
    */
    ...
    fn int_hop_get13<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L13 {
        match T::child_layer_id {
            Some(14) => {
                let l14 = self.int_get14(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get12<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L12 {
        match T::child_layer_id {
            ...
            Some(13) => {
                let l13 = self.int_get13(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get11<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L11 {
        match T::child_layer_id {
            ...
            Some(12) => {
                let l12 = self.int_get12(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get10<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L10 {
        match T::child_layer_id {
            ...
            Some(11) => {
                let l11 = self.int_get11(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get9<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L9 {
        match T::child_layer_id {
            ...
            Some(10) => {
                let l10 = self.int_get10(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get8<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L8 {
        match T::child_layer_id {
            ...
            Some(9) => {
                let l9 = self.int_get9(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get7<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L7 {
        match T::child_layer_id {
            ...
            Some(8) => {
                let l8 = self.int_get8(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get6<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L6 {
        match T::child_layer_id {
            ...
            Some(7) => {
                let l7 = self.int_get7(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get5<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L5 {
        match T::child_layer_id {
            ...
            Some(6) => {
                let l6 = self.int_get6(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get4<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L4 {
        match T::child_layer_id {
            ...
            Some(5) => {
                let l5 = self.int_get5(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get3<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L3 {
        match T::child_layer_id {
            ...
            Some(4) => {
                let l4 = self.int_get4(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get1<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L1 {
        match T::child_layer_id {
            ...
            Some(3) => {
                let l3 = self.int_get3(parent, index.clone(), parent_index.clone());
                self.int_hop_get1(l3, index, parent_index)
            },
            Some(2) => {
                let l2 = self.int_get2(parent, index.clone(), parent_index.clone());
    ...
    fn int_hop_get0<T: LayerInfo>(&self, parent: &T, index: LodIndex, parent_index: LodIndex) -> &X::L0 {
        match T::child_layer_id {
            ...
            Some(1) => {
                let l1 = self.int_get1(parent, index.clone(), parent_index.clone());
    ...
    pub fn get14(&self, index: LodIndex) -> &X::L14 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get14(l15, index.clone(), index)
        } else {
    ...
    pub fn get13(&self, index: LodIndex) -> &X::L13 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get13(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get13(l14, index.clone(), index)
        } else {
    ...
    pub fn get12(&self, index: LodIndex) -> &X::L12 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get12(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get12(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get12(l13, index.clone(), index)
        } else {
    ...
    pub fn get11(&self, index: LodIndex) -> &X::L11 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get11(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get11(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get11(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get11(l12, index.clone(), index)
        } else {
    ...
    pub fn get10(&self, index: LodIndex) -> &X::L10 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get10(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get10(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get10(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get10(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get10(l11, index.clone(), index)
        } else {
    ...
    pub fn get9(&self, index: LodIndex) -> &X::L9 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get9(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get9(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get9(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get9(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get9(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get9(l10, index.clone(), index)
        } else {
    ...
    pub fn get8(&self, index: LodIndex) -> &X::L8 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get8(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get8(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get8(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get8(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get8(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get8(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get8(l9, index.clone(), index)
        } else {
    ...
    pub fn get7(&self, index: LodIndex) -> &X::L7 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get7(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get7(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get7(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get7(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get7(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get7(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get7(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get7(l8, index.clone(), index)
        } else {
    ...
    pub fn get6(&self, index: LodIndex) -> &X::L6 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get6(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get6(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get6(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get6(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get6(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get6(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get6(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get6(l8, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L7::child_layer_id {
            let l7 = self.get7(index.clone());
            self.int_hop_get6(l7, index.clone(), index)
        } else {
    ...
    pub fn get5(&self, index: LodIndex) -> &X::L5 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get5(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get5(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get5(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get5(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get5(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get5(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get5(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get5(l8, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L7::child_layer_id {
            let l7 = self.get7(index.clone());
            self.int_hop_get5(l7, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L6::child_layer_id {
            let l6 = self.get6(index.clone());
            self.int_hop_get5(l6, index.clone(), index)
        } else {
    ...
    pub fn get4(&self, index: LodIndex) -> &X::L4 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get4(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get4(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get4(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get4(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get4(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get4(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get4(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get4(l8, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L7::child_layer_id {
            let l7 = self.get7(index.clone());
            self.int_hop_get4(l7, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L6::child_layer_id {
            let l6 = self.get6(index.clone());
            self.int_hop_get4(l6, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L5::child_layer_id {
            let l5 = self.get5(index.clone());
            self.int_hop_get4(l5, index.clone(), index)
        } else {
    ...
    pub fn get3(&self, index: LodIndex) -> &X::L3 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get3(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get3(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get3(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get3(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get3(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get3(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get3(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get3(l8, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L7::child_layer_id {
            let l7 = self.get7(index.clone());
            self.int_hop_get3(l7, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L6::child_layer_id {
            let l6 = self.get6(index.clone());
            self.int_hop_get3(l6, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L5::child_layer_id {
            let l5 = self.get5(index.clone());
            self.int_hop_get3(l5, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L4::child_layer_id {
            let l4 = self.get4(index.clone());
            self.int_hop_get3(l4, index.clone(), index)
        } else {
    ...
    pub fn get2(&self, index: LodIndex) -> &X::L2 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get2(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get2(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get2(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get2(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get2(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get2(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get2(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get2(l8, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L7::child_layer_id {
            let l7 = self.get7(index.clone());
            self.int_hop_get2(l7, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L6::child_layer_id {
            let l6 = self.get6(index.clone());
            self.int_hop_get2(l6, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L5::child_layer_id {
            let l5 = self.get5(index.clone());
            self.int_hop_get2(l5, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L4::child_layer_id {
            let l4 = self.get4(index.clone());
            self.int_hop_get2(l4, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L3::child_layer_id {
            let l3 = self.get3(index.clone());
            self.int_hop_get2(l3, index.clone(), index)
        } else {
    ...
    pub fn get1(&self, index: LodIndex) -> &X::L1 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get1(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get1(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get1(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get1(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get1(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get1(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get1(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get1(l8, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L7::child_layer_id {
            let l7 = self.get7(index.clone());
            self.int_hop_get1(l7, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L6::child_layer_id {
            let l6 = self.get6(index.clone());
            self.int_hop_get1(l6, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L5::child_layer_id {
            let l5 = self.get5(index.clone());
            self.int_hop_get1(l5, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L4::child_layer_id {
            let l4 = self.get4(index.clone());
            self.int_hop_get1(l4, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L3::child_layer_id {
            let l3 = self.get3(index.clone());
            self.int_hop_get1(l3, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L2::child_layer_id {
            let l2 = self.get2(index.clone());
            self.int_hop_get1(l2, index.clone(), index)
        } else {
    ...
    pub fn get0(&self, index: LodIndex) -> &X::L0 {
        if Some(X::anchor_layer_id) == X::L15::child_layer_id {
            let l15 = self.get15(index.clone());
            self.int_hop_get0(l15, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L14::child_layer_id {
            let l14 = self.get14(index.clone());
            self.int_hop_get0(l14, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L13::child_layer_id {
            let l13 = self.get13(index.clone());
            self.int_hop_get0(l13, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L12::child_layer_id {
            let l12 = self.get12(index.clone());
            self.int_hop_get0(l12, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L11::child_layer_id {
            let l11 = self.get11(index.clone());
            self.int_hop_get0(l11, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L10::child_layer_id {
            let l10 = self.get10(index.clone());
            self.int_hop_get0(l10, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L9::child_layer_id {
            let l9 = self.get9(index.clone());
            self.int_hop_get0(l9, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L8::child_layer_id {
            let l8 = self.get8(index.clone());
            self.int_hop_get0(l8, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L7::child_layer_id {
            let l7 = self.get7(index.clone());
            self.int_hop_get0(l7, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L6::child_layer_id {
            let l6 = self.get6(index.clone());
            self.int_hop_get0(l6, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L5::child_layer_id {
            let l5 = self.get5(index.clone());
            self.int_hop_get0(l5, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L4::child_layer_id {
            let l4 = self.get4(index.clone());
            self.int_hop_get0(l4, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L3::child_layer_id {
            let l3 = self.get3(index.clone());
            self.int_hop_get0(l3, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L2::child_layer_id {
            let l2 = self.get2(index.clone());
            self.int_hop_get0(l2, index.clone(), index)
        } else if Some(X::anchor_layer_id) == X::L1::child_layer_id {
            let l1 = self.get1(index.clone());
            self.int_hop_get0(l1, index.clone(), index)
        } else {
